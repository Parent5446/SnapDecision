...
abstract class ProcessCache
{
	 ...
	 */
	public function update( Model $obj, array $info ) {
	 ...
	 * @throws \RuntimeException If the factory function returns an improper value
	 */
	protected function create( $field, $value ) {
		...
		$obj = call_user_func( [ $class, $function ], $this->deps, $value );
		if ( !$obj ) {
